...
### Actually Deploying
1. From the `terraform/` directory you canrun `terraform apply` and be sure to type `yes` when prompted if you actually want to apply changes. Any other answer will stop the process
